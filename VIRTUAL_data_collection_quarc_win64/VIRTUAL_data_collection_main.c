...
typedef RT_MODEL_VIRTUAL_data_collect_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * VIRTUAL_data_collection(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(VIRTUAL_data_collection_M, GBLbuf.message);
}
...
static subrate_info_T subrate_info[6];
...
static int_T tSubRate(RT_MODEL * S, qsem_t * sem, int_T tid)
{
  while (1) {
    t_error result;
    t_boolean is_sample2_hit = false;
    t_boolean is_sample3_hit = false;
    t_boolean is_sample4_hit = false;
    t_boolean is_sample5_hit = false;
    t_boolean is_sample6_hit = false;
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&VIRTUAL_data_collection_DW.ComputationTime_ComputationTi_n,
           &end_time, &VIRTUAL_data_collection_DW.ComputationTime_BeginTime_d);
      }
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&VIRTUAL_data_collection_DW.ComputationTime_ComputationTi_e,
           &end_time, &VIRTUAL_data_collection_DW.ComputationTime_BeginTime_c);
      }
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&VIRTUAL_data_collection_DW.ComputationTime_ComputationTi_g,
           &end_time, &VIRTUAL_data_collection_DW.ComputationTime_BeginTime_f);
      }
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&VIRTUAL_data_collection_DW.ComputationTime_ComputationTi_c,
           &end_time, &VIRTUAL_data_collection_DW.ComputationTime_BeginTime_o);
      }
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&VIRTUAL_data_collection_DW.ComputationTime_ComputationTi_d,
           &end_time, &VIRTUAL_data_collection_DW.ComputationTime_BeginTime_f4);
      }
  ...
  control_c_handler(int signal_number)
{
  ...
  GBLbuf.stopExecutionFlag = 1;
  rtExtModeStart();
  hil_task_stop(VIRTUAL_data_collection_DW.HILReadTimebase_Task)
    ;
}
  ...
  main(int argc, char * argv[])
{
  ...
  int max_priority = qsched_get_priority_max(QSCHED_FIFO) - 6;
  qsigset_t signal_set;
  qsigaction_t action;
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://VIRTUAL_data_collection:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: VIRTUAL_data_collection -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
  ...
  if (rtExtModeQuarcStartup(rtmGetRTWExtModeInfo(S),
    ...
    if (rtmGetErrorStatus(S) == NULL) {
      ...
      for (subrate_index = 5; subrate_index >= 0; --subrate_index) {
      ...
      if (subrate_index < 0) {         /* all threads successfully created */
        ...
        fflush(stdout);
        result = hil_task_start(VIRTUAL_data_collection_DW.HILReadTimebase_Task,
          (t_clock) VIRTUAL_data_collection_P.HILReadTimebase_Clock, 500.0, -1)
          ;
        if (result == 0) {
        ...
        for (subrate = 0; subrate < 6; subrate++) {
       ...
       */
      for (subrate_index++; subrate_index < 6; subrate_index++) {
