...
typedef RT_MODEL_QCar2_Virtual_calibr_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * QCar2_Virtual_calibrate(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QCar2_Virtual_calibrate_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://QCar2_Virtual_calibrate:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QCar2_Virtual_calibrate -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
