###########################################################################
## Makefile generated for component 'QCar2_Virtual_calibrate'. 
## 
## Makefile     : QCar2_Virtual_calibrate.mk
## Generated on : Tue Mar 17 15:20:34 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\QCar2_Virtual_calibrate.rt-win64
...
PRODUCT_NAME              = QCar2_Virtual_calibrate
MAKEFILE                  = QCar2_Virtual_calibrate.mk
...
COMPILER_COMMAND_FILE     = QCar2_Virtual_calibrate_comp.rsp
CMD_FILE                  = QCar2_Virtual_calibrate.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\QCar2_Virtual_calibrate.rt-win64
...
DEFINES_STANDARD = -DMODEL=QCar2_Virtual_calibrate -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate.c $(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate_data.c $(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate_main.c $(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = QCar2_Virtual_calibrate.obj QCar2_Virtual_calibrate_data.obj QCar2_Virtual_calibrate_main.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
LIBS = C:\PROGRA~1\Quanser\QUARC\lib\win64\QUANSE~2.LIB C:\PROGRA~1\Quanser\QUARC\lib\win64\QUANSE~1.LIB C:\PROGRA~1\Quanser\QUARC\lib\win64\QUANSE~4.LIB C:\PROGRA~1\Quanser\QUARC\lib\win64\hil.lib C:\PROGRA~1\Quanser\QUARC\lib\win64\QUANSE~3.LIB C:\PROGRA~1\Quanser\QUARC\lib\win64\QUEE2B~1.LIB
...
{$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
QCar2_Virtual_calibrate.obj : "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate.c"


QCar2_Virtual_calibrate_data.obj : "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate_data.c"


QCar2_Virtual_calibrate_main.obj : "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\QCar2_Virtual_calibrate_main.c"


rt_nonfinite.obj : "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\QCar2_Virtual_calibrate_quarc_win64\rt_nonfinite.c"
