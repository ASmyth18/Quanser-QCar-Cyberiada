...
typedef RT_MODEL_VIRTUAL_self_driving_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * VIRTUAL_self_driving_stack_v2(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(VIRTUAL_self_driving_stack_v_M, GBLbuf.message);
}
  ...
  control_c_handler(int signal_number)
{
  ...
  GBLbuf.stopExecutionFlag = 1;
  rtExtModeStart();
  hil_task_stop(VIRTUAL_self_driving_stack_v_DW.HILReadTimebase_Task)
    ;
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://VIRTUAL_self_driving_stack_v2:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: VIRTUAL_self_driving_stack_v2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = VIRTUAL_self_driving_stack_v2();
  if (rtmGetErrorStatus(S) != NULL) {
    ...
    if (rtmGetErrorStatus(S) == NULL) {
      ...
      if (subrate_index < 0) {         /* all threads successfully created */
        ...
        result = hil_task_start
          (VIRTUAL_self_driving_stack_v_DW.HILReadTimebase_Task, (t_clock)
           VIRTUAL_self_driving_stack_v2_P.HILReadTimebase_Clock, 500.0, -1)
          ;
        if (result == 0) {
